...
- (id)initWithFrame:(CGRect) rect
{
    ...
    if (self)
    {
        ...
        tfFeedbackCode.placeholder = @"... enter rate code ...";
...
-(void) rateButton
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            FeedbackViewController* fbvc = [[FeedbackViewController alloc] initWithQuestion:answer.value code:code time:answer.leftTimeInSec];
